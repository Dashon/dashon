  ...
  return (
    <section id="home" className="home d-flex align-items-center">
      <div className="container">
        <div className="intro">
          <img src="images/avatar-1.svg" alt="Dashon" className="mb-4" />
          ...
          <ul className="social-icons light list-inline mb-0 mt-4">
            <li className="list-inline-item">
              <a href="https://linkedin.com/in/dashon" target="_dashonExt">
                <i className="fab fa-linkedin"></i>
              </a>
            </li>
            <li className="list-inline-item">
              <a href="https://github.com/dashon" target="_dashonExt">
          ...
          <div className="mt-4 d-flex flex-wrap gap-2 justify-content-center">
            ...
            <button
              ...
              style={{ border: "2px solid #FF4C60", color: "#333", padding: "10px 30px" }}
              onClick={() => {
